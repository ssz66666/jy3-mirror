                    ...
                    while int_选项 == 0 do
                        ...
                        if int_选项 == 1 then
                            ...
                            if G.call('get_point',41) < 0 then 
                                ...
                                G.call('set_role',int_no,13,G.call('get_role',int_no,1))
...
t['聚贤庄任务_良辰吉日']=function()
    ...
    if G.QueryName(0x10030001)[tostring(51)] >  0 and G.QueryName(0x10030001)[tostring(13)] > 0 then 
        G.call("talk",'',38,'   你到底想结几次婚，不怕家宅不宁吗？这又是哪家姑娘这么不幸会被你看上？',1,1) 
        G.call("talk",'',0,'   被我看中，那是她的福气。你且猜猜这个女孩是谁？',0,0) 
        G.call("talk",'',38,'   她现在你的队伍里吗？',1,1) 
    else
        G.call("talk",'',38,'   你终于忍不住寂寞，打算要讨老婆了吗？告诉我是哪家的姑娘这么不幸会被你看上？',1,1) 
        G.call("talk",'',0,'   被我看中，那是她的福气。你且猜猜这个女孩是谁？',0,0) 
        G.call("talk",'',38,'   她现在你的队伍里吗？',1,1) 
    end   
    local o_team = G.QueryName(0x10110001)
...
t['聚贤庄任务_擂鼓山棋局']=function()
    ...
    if G.call('in_team',35) == false  and  (G.call('get_point',8) == 0 or G.call('get_point',8) == 2)  then 
        ...
        G.call('set_role',35,13,G.call('get_role',35,1))
...
t['聚贤庄任务_迷途的小和尚']=function()
    ...
    if G.call('get_love',35) >= 60 and G.call('get_point',8) == 2 then 
        ...
        if G.call('team_full') == false then 
            G.call("talk",'',35,'   那就有劳施主带路了。',1,1) 
            G.call('join',35)
        else
            G.call("talk",'',35,'   多谢施主好意，但是施主的队伍已满，我无法加入了。',1,1) 
        end
    end
    G.call('dark')
    G.call('goto_map',4) 
...
t['聚贤庄任务_御厨的无奈']=function()
    ...
    G.call('all_over')
    G.call('talk0','御  厨','   这位大侠啊，我可不比你这种练家子。我可经不起长途跋涉啊，我可是个尙膳监的有名御厨，你拿我去酿酒，那不是小题大做吗？',126,143)
    ...
    o_battle_结果 = G.call('get_battle')
    if o_battle_结果  == 1 then 
        G.call('talk0','御  厨','   多谢大侠相救。不过我也回不了皇宫了，那厮一定还会再去找我，我回家抱孩子算了。不过为了表达我的谢意，我要把我的平生所学都传给你..',126,143)
    ...
    while int_选项 == 0 do
        ...
        if int_选项 == 1 then
            ...
            if o_battle_结果  == 1 then 
                ...
                G.call("talk",'',83,'   自不量力的小子，快些给我滚！',1,1) 
            end
        elseif int_选项 == 2 then
            G.call('all_over')
            ...
            if o_battle_结果  == 1 then 
                ...
                G.call("talk",'',83,'   自不量力的小子，你哪里是这女魔头的敌手，你赶快走吧！',1,1) 
            end
        end
    end
    G.call('dark')
...
t['聚贤庄任务_全真教与桃花岛的恩怨']=function()
    ...
    G.call("talk",'',82,'   坏我事的小子，我要你的命！',1,1)
    G.call('all_over')
    ...
    if o_battle_结果  == 1 then 
        ...
        G.call("talk",'',83,'   你这傻小子也太莽撞，你以为老毒物偷袭就能伤的了我吗？他的蛤蟆功击在石头上也能粉碎，你小子强出头，那是以卵击石！',1,1) 
...
t['聚贤庄任务_东郭狼子心']=function()
    ...
    while int_选项 == 0 do
        ...
        if int_选项 == 1 then
            ...
            G.call("talk",'',100,'   不是我，不是我。是这个小子，他硬要给五姑治病，我拦不住，正要教训他呢。',1,1) 
            G.call("talk",'',108,'   放屁！把这混小子给我宰了，否则你别想再让那个贱人活着！',1,1) 
...
t['聚贤庄任务_青城派的仇怨']=function()
    ...
    if o_battle_结果  == 1 then
        ...
        G.call("talk",'青城三秀',236,'   臭小子多管闲事，下次让我们碰到要你的小命！',1,1) 
    end  
    G.call('all_over')
    G.call('dark')
    G.call('goto_map',4)
...
t['聚贤庄任务_救治盲女']=function()
    ...
    if G.call('in_team',29) == true then
        ...
        G.call("talk",'',19,'   原来这个铁丑就是你口中所说的什么“游兄”！这小子曾经不只一次想毒害我姐夫，他还拼命巴结我，就是想哄骗我嫁给他。而且他不死，我怎么有位置加入你的队伍呀。',1,1) 
        G.call('leave',29)
        G.call('join',19)
        G.call('dark')
...
t['聚贤庄任务_老尼姑的险境']=function()
    ...
    if o_battle_结果  == 1 then
        ...
        if G.call('get_point',15) >= 80 then 
            G.call("talk",'',193,'   老尼命不久矣！希望少侠能代我执掌恒山，不要让...让恒山一脉从武林消失...（口吐鲜血，伤重而逝）',1,1)
...
t['聚贤庄任务_三件礼物']=function()
    ...
    G.call("talk",'神雕侠',199,'   襄阳城郭大侠的小女儿——郭襄，与我渊源颇深，过几日便是她的十六岁芳辰，我要给她筹备几件礼物，既叫她欢喜，也是对襄阳百姓有莫大的好处。',1,1) 
...
t['聚贤庄任务_死守襄阳城']=function()
    ...
    G.call("talk",'',81,'   你这混小子，又来捣乱吗？我先拿祭旗，再来对付郭靖！',1,1) 
    G.call('all_over')
    ...
    if o_battle_结果  == 1 then
        ...
        if G.call('team_full') == false then 
            ...
            G.call('set_role',37,13,G.call('get_role',37,1))
    ...
    while int_选项 == 0 do
        ...
        if int_选项 == 1 then
            ...
            if o_battle_结果  == 1 then
                ...
                G.call("talk",'',30,'   好小子，看来你是真有心要跟我争抢这个西夏公主了！咱们走着瞧，我得不到的东西，别人也休想得到！',1,1) 
...
t['聚贤庄任务_归云庄英雄大会']=function()
    ...
    while int_选项 == 0 do
        ...
        if int_选项 == 1 then 
            ...
            o_battle_结果 = G.call('get_battle') 
            if o_battle_结果  == 1 then
                G.call("talk",'',121,'   好厉害的小子，我来接你这一场...',1,1) 
                G.call('all_over') 
                G.call('call_battle',1,43,1,100,121,0,0,0,0,0)
                o_battle_结果 = G.call('get_battle') 
                if o_battle_结果  == 1 then
                    G.call("talk",'',121,'   师父，这小子是大师兄转世，他的武功高出我很多，刚才我用藏语说“我是金轮国师的弟子”，他竟然也说是您的弟子，他一定是大师兄转世啦..',1,1) 
                    G.call("talk",'',81,'   达尔巴！他不是你大师兄转世，他是在学你说话。',1,1) 
                    G.call("talk",'',81,'   老衲便是金轮法王，施主打过了老衲的两个不争气徒儿倒确实令老衲很是意外。想不到中原武林还有你这样杰出的后辈。老衲今天可要领教领教。',1,1) 
                    G.call('all_over') 
        ...
        if int_选项 == 1 then 
            ...
            if G.call('get_magic',204) > 0 then 
                ...
                if o_battle_结果  == 1 then
                    ...
                    G.call("talk",'',139,'   你这小子真是自不量力！我们今天不想多伤人命，就放你一条生路赶紧离开这吧！',1,1) 
                    G.call("talk",'',143,'   娘的，这小子看起来咋咋呼呼，哪知顶个屁用！还得我亲自料理这几个老混蛋。',1,1) 
                end
            else
...
t['聚贤庄任务_镖车被劫']=function()
	...
	while int_选项 == 0 do
        ...
        if int_选项 == 1 then 
            ...
            o_battle_结果 = G.call('get_battle')
            if o_battle_结果  == 1 then 
                G.call("talk",'镖  师',228,'   多谢大侠出手相助，这点谢礼不成敬意，务请收下。',1,1) 
                G.call('add_point',15,5)
...
t['聚贤庄任务_爪下白骨']=function()
    ...
    o_battle_结果 = G.call('get_battle')
    if o_battle_结果  == 1 then 
        G.call("talk",'',89,'   臭小子你坏我好事，下次要你的小命！',1,1) 
...
t['聚贤庄任务_阮姓何辜']=function()
    ...
    o_battle_结果 = G.call('get_battle')
    if o_battle_结果  == 1 then 
        G.call("talk",'',135,'   臭小子你坏我好事，下次要你的小命！',1,1) 
        G.call('add_point',15,math.random(10))
    else
...
t['聚贤庄任务_神秘商人']=function()
    ...
    if G.call('通用_神秘商店') then 
        ...
        if math.random(100) == 1 then
            G.call("talk",'',148,'   为答谢顾客，本店免费赠品附送与你1',2,1)
