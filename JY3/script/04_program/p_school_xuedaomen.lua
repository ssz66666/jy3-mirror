...
t['初入血刀门'] = function()
    ...
    G.call("talk",'',249,'   这位师弟怎么看起来傻愣愣的，他能将本门发扬光大吗？还有这位水姑娘，我觉得师弟拿不下！',2,1) 
    G.call("talk",'',143,'   那倒未必，依为师看来，你师弟潜力无限，相信为师不会看走眼的，至于说水姑娘，宝象你先将她带至后山山洞，改日就看你师弟的了！',2,1) 
        ...
        if int_选项 == 1 then 
            if G.call('get_magic',17) < 1  then 
                if G.call('get_magic_lv',204) == 5 then 
                    G.call("talk",'',249,'   这手【奇门三才刀】师弟可看仔细了！',2,1)  
            ...
            elseif G.call('get_magic',20) < 1 then 
                if G.call('get_magic',17) >= 10 then 
                    G.call("talk",'',249,'   这手【修罗刀】师弟可看仔细了！',2,1)  
            ...
            elseif G.call('get_magic',203) < 1 then 
                if G.call('get_magic',20) >= 10 then 
                    G.call("talk",'',249,'   这手【灭仙掌】师弟可看仔细了！',2,1)  
