...
t['事件_随机切磋']=function()
   ...
   --lv91~ lv100 20000+
    ...
    G.call('call_battle',1,10,1,200,int_role,0,0,0,0,0)
    ...
    while true do 
       ...
       if int_层数判定 == 0 then
        ...
        if int_模式 == 1 then 
            ...
            G.call('call_battle',1,80,3,100 + G.misc().通天塔层数*5 ,team_final[2],team_final[1],team_final[3],team_final[4],team_final[5],team_final[6])
