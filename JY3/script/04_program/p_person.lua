...
t['副本_通天塔']=function(int_模式)
    ...
    while true do 
       ...
       if int_层数判定 == 0 then
        ...
        if int_模式 == 1 then 
            G.call('call_battle',0,80,1,100 + G.misc().通天塔层数*7 ,team_final[2],team_final[1],team_final[3],team_final[4],team_final[5],team_final[6],0,0,1)
        else
            G.call('call_battle',0,80,3,100 + G.misc().通天塔层数*7 ,team_final[2],team_final[1],team_final[3],team_final[4],team_final[5],team_final[6],0,0,1)
