...
t['事件_随机切磋']=function()
   ...
   --lv91~ lv100 20000+
    ...
    for i = 1,#role do
        ...
        if int_hp > 0 and (not G.call('get_role',i,901) or  (G.call('get_role',i,901) == 0) or (G.call('get_role',i,901) > 30000) )    then --判断为非队友
...
t['副本_通天塔']=function(int_模式)
    ...
    while true do 
       ...
       if int_层数判定 == 0 then
        ...
        if int_模式 == 1 then 
            G.call('call_battle',1,80,1,100 + G.misc().通天塔层数*5 ,team_final[2],team_final[1],team_final[3],team_final[4],team_final[5],team_final[6],0,0,1)
        else
            G.call('call_battle',1,80,3,100 + G.misc().通天塔层数*5 ,team_final[2],team_final[1],team_final[3],team_final[4],team_final[5],team_final[6],0,0,1)
