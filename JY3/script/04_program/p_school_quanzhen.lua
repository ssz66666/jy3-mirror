	...
	while int_选项 == 0 do
        ...
        elseif int_选项 == 2 then 
            ...
            if o_battle_结果  == 1 then
                ...
                G.call("talk",'',214,'   混[小子]，我可是你师兄啊，你还真敢用功夫打我！下次看我怎么教训你！',2,1) 
            else 
                G.call('add_love',214,3)
                G.call("talk",'',214,'   [师弟]承让了，我好歹掌教弟子的得意高徒，怎么可能会输给你呢，哈哈哈哈。',2,1) 
            end 
            G.call('all_over')
            G.call('add_time',4)
            G.call('turn_map') 
