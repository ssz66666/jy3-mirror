...
t['牛家村-黄蓉']=function()
    if G.call('team_full') == false then  
        ...
        G.call("talk",'',12,'   所以我认为你是个好人，我要跟你在一起，要是有人欺负你，我就帮你教训他们！蓉儿的【软猬甲】就送给'..G.QueryName(0x10030001)[tostring(2)]..'哥哥做见面礼啦。',2,1) 
        G.call('join',12)
        ...
        G.call("talk",'',12,'   '..G.QueryName(0x10030001)[tostring(2)]..'哥哥，你还记得我吗，我就是当日在破庙里的那个【乞丐丙】呀。从小我就失了娘亲，我又和爹爹闹翻，只有你不嫌弃我，关照我。',2,1) 
        G.call("talk",'',12,'   所以我认为你是个好人，我要跟你在一起，要是有人欺负你，我就帮你教训他们！可是'..G.QueryName(0x10030001)[tostring(2)]..'哥哥好像已经不需要我了。',2,1)         
        G.call('all_over') 
    end  
    G.call('turn_map')  
end     
        ...
        if int_选项 == 1 then 
            ...
            if  G.call('getprice') > 0 then 
                if  G.call('getprice') < G.call('get_money')  then 
                   ...
                   G.call("talk",'肉  贩',49,'   钱不够？没钱就别乱动老子卖的肉！这位小哥的玩笑可是开大了。小店本小利微，可经不起吃白食啊。你点了这么多饭菜，而你的钱袋好似不够鼓啊。',1,1)
               end 
            else
            end  
            G.call("talk",'肉  贩',49,'   新鲜的肉嘞，童叟无欺价格公道！',1,1)
