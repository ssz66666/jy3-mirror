...
function t:详细显示()
    ...
    elseif  G.misc().book == 3 then
        ...
        str = {'加血(主动技能)','杀内','吸内(上限)','减伤','闪避','复活(主动技能)','强化','免疫中毒','回气','回血','回内','吸内','反伤','免疫封穴','免疫内伤','御风(主动技能)','纯阳'}
        ...
        if o_skill.类别 == 9 then
            local str_阵法效果 = {'每名存活队友降低敌人内功防御5%','每名存活队友增加慈悲效果10%','每名存活队友增加剑法伤害5%','每名存活队友增加内功回复效果1%','有存活队友情况下或者会左右互搏玉女素心剑法增加增加破防效果','每名存活队友增加10%控制几率','全队友存活时任何单体攻击变为攻击群体'}
