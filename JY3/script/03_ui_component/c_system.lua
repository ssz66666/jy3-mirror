...
function t:start()
    ...
    self.关于.text = '                   [0a]关于2019版[08]《金庸群侠传3》[0a]说明：[br]    [03]《金庸群侠传3》[0a]原版是由[03]半瓶神仙醋·郭磊[0a]开发的一款角色扮演游戏，于2009年发行。该作品沿袭[03]《金庸群侠传2》[0a]采用自由开放的金书世界，该作的故事和门派以及战斗等至今还让人津津乐道；此次的2019版在获得[03]半瓶神仙醋·郭磊[0a]的授权后精心制作，在保留原游戏内容外增加和改动的有以下内容：[br][02]  1，[0a]原游戏战斗系统采用的是全部人物完全独立的ATB集气，新版改成[03]统一[0a]的集气，和原作不同的是先集气再根据选择的武功招式的气槽进行读条施放；[br][02]  2，[0a]人物增加[03]被动技能[0a]，队友的可在查看状态的时候查看被动效果，马车队友增加到[03]上限12名[0a]，队友可参加的战斗可以选择出战；[br]  [02]3，[0a]小游戏少林寺[03]藏经阁[0a]简化；另外增加一个[03]猜数字、拼图[0a]的等小游戏，在游戏中可以尽情游玩；[br][02]  4，[0a]增加[03]周目与成就[0a]系统，继承通关存档的下周目根据成就积分获得一定的修行点，同时主角根据成就积分随机获得一定个数的被动技能，上限4个；[br][02]  5，[0a]增加[03]峨嵋、丐帮、星宿派、桃花岛、血刀门[0a]剧情，同时增加[03]梦幻模式[0a]剧情，更有[03]无尽模式[0a]以及[03]随机切磋[0a]等你挑战；增加[03]神奇装备[0a]、套装获取，让游戏内容更加丰富。[br]    以上是新版改动较多的几点，同时新版根据[03]移动端[0a]做了部分优化，比如增加了侧边栏的选择项，增加了战斗菜单的武功选择侧边框；制作仓促发现BUG可[03]游戏内置公告[0a]加群反映，后续会作持续优化；攻略内容可以加公告公众号或者[03]铁血丹心(大武侠)[0a]论坛查找；[br]    最后感谢[03]半瓶神仙醋·郭磊[0a]的付出，感谢[03]QQ1041733430[0a]好友"美娜"的测玩，感谢[03]铁血丹心（大武侠）[0a]论坛朋友们帮助以及对本作的关心与付出的你们，that is all..........'
