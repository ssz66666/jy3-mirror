...
function t:rollOver(tar)
    ...
    local magic = {'破绽','慈悲','先攻','妙手','急速','冰心','暴击','激励','见切','万毒','强体','回春','强力','强行','复生','奇才','活力','阴毒','舔血','北冥','真武','朱雀','玄武','青龙','白虎','指心','拳劲','剑意','刀魂','奇门','寒气','圣火'}
    local str1 = '增加全队伤害基值'
    ...
    local str16 = '招式武功获得经验翻倍,升级时等级为偶数时修为额外加1,装备爆率+1%'
