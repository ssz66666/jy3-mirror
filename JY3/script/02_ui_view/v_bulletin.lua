...
tp = tc
	...
	tp = tc
		...
		tp = tc
			...
			tc.scaleY = 0.500
			tc.autosize = 2
			tc.text = '[04]一，开局增加女性角色系统，将原有结义成绩和结婚成就分离平分（更新后会出现总成就点降低，需完成女性结婚结义成就）；[br]二，峨嵋派剧情加入：第二日女性角色加入峨嵋，男性角色入少林;[br]三，取消狗狗密令获得阵法效果，取而代之加入门派宗师完美成就开启，如果完美门派宗师，则在进入聚贤庄时该完美门派宗师会自动习得该门派阵法和绝招；[br]四，队友经验系统植入，没满属性队友战斗可以获得经验，每满10000经验则全属性提升，可在战斗中关闭队友获得经验，原队友切磋将随机获得1000-3000经验;[br]五，增加主角自动攻击设置；[br]六，取消原增加二次结义与结婚密令，增加密令“我的侠客”，效果：随机添加一名队友，随机获得二次结义或者结婚效果；[br]七，礼包密令到期取消，下次公告再见；'
			tc.wrap = true
			tc.font = 0x603c0000
			tc.style = 5
			tp = tc
